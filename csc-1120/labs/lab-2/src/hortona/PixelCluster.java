...
public enum PixelCluster {
     ...
     * @throws InvalidFormatException if array contains numbers that aren't 1 or 0
     */
    public static PixelCluster getCluster(int[][] cluster)
            ...
            for (int i = 0; i < cluster.length; i++) {
                for (int j = 0; j < cluster[0].length; j++) {
                    if (cluster[i][j] == 0 || cluster[i][j] == 1) {
                        ...
                        throw new InvalidFormatException("Not a valid pixel cluster");
                    }
                }
            }
        } else {
            throw new IllegalArgumentException("Not a 2x2 cluster");
        }
        ...
        switch(clusterString) {
            ...
            default -> throw new InvalidFormatException("Not a valid pixel cluster");
        }
     ...
     * @throws InvalidFormatException If given a character that isn't a Unicode block
     */
    public static int[][] getPixels(char code)
        ...
        return switch (code) {
            ...
            default -> throw new InvalidFormatException("Not a valid unicode block");
        };
