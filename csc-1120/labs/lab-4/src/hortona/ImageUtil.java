...
public final class ImageUtil {
    ...
    public static void writeImage(Path path, Image image) throws IOException,
        ...
        try (OutputStream out = Files.newOutputStream(path)) {
            // Remove transparency layer to write JPGs since OpenJDK does not provide a native
            // JPEG encoder.
     ...
     * @throws IllegalArgumentException if kernel size is out of range
     */
