...
/**
 * This class is responsible for verifying the correct operation of a given
 * term.
 * 
 * @author schilling
 *
...
public class TestTerm {
    @DataProvider
    /**
     * This data provider will verify that the normal constructor behavior is
     * proper.
     * 
     * @return
     */
    public Object[][] normalConstructorDataProvider() {
        return new Object[][] {
                ...
                new Object[] { AcademicQuarter.SUMMER, 1900 },
        };
    }
    ...
    /**
     * This will test that an invalid year throws a BadParameter Exception.
     */
    public void testInvalidYear() throws BadParameter {
        new Term(AcademicQuarter.WINTER, 1899);
    }
    ...
    public Object[][] comparisonDataProvider() throws BadParameter {
        ...
        Term t4 = new Term(AcademicQuarter.WINTER, 2000);
        Term t5 = new Term(AcademicQuarter.SUMMER, 2001);

        /**
         * Set of sets of them to use for comparison. The third value is -1 if less than
    ...
    @DataProvider
    public Object[][] calculateTermGPAProvider() {
        return new Object[][] {
                new Object[] { 1, LetterGradeEnum.A, 4.0 },
                new Object[] { 4, LetterGradeEnum.F, 0.0 },
                new Object[] { 5, LetterGradeEnum.AB, 3.5 },
        };
    }

    @Test(groups = { "TestTerm" }, dataProvider = "calculateTermGPAProvider")
    public void testCalculateTermGPA(int credits, LetterGradeEnum grade, double expected) throws BadParameter {
        Term t = new Term(null, 1969);
        t.addCourse(new CompletedCourse("course", credits, grade));
        assertEquals(t.calculateTermGPA(), expected);
    }
    ...
    public Object[][] equalsDataProvider() throws BadParameter {
        ...
        Term t6 = new Term(AcademicQuarter.FALL, 1975);
        Term t7 = new Term(AcademicQuarter.FALL, 1975);
        t6.addCourse(new CompletedCourse("potato growing", 4, LetterGradeEnum.F));
        t7.addCourse(new CompletedCourse("C++", 4, LetterGradeEnum.AB));
    ...
    /**
     * This test will verify that the most basic operation of adding a course to the
     * term works properly.
     */
    ...
    @Test(groups = { "TestTerm" })
    /**
     * This test will ensure that trying to add a course which is already in the
    ...
    @DataProvider
    /**
     * This data provider verifies that the term GPA is handled properly by adding a
     * set of courses
     * that a specific GPA has been set to for testing purposes. The format is a
     * list of courses
     * followed by three booleans, one for good standing, one for probation, and one
     * for honors.
     */
