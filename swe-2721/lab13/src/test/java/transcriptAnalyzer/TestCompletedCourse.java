...
public class TestCompletedCourse {
     ...
     * constructor. The first part of the data provider is the course name, followed
     * by the credits, followed by the letter grade earned.
     */
    public Object[][] invalidOperationDataProvider() {
        return new Object[][] {
                ...
                new Object[] { "B", 2, LetterGradeEnum.AB },
                new Object[] { "CAT", -1, LetterGradeEnum.AB },
        };
    }
    ...
    public Object[][] normalOperationDataProvider() {
        return new Object[][] {
                new Object[] { "Basket Weaving 101", 1, LetterGradeEnum.A },
                new Object[] { "Basket Weaving 102", 2, LetterGradeEnum.AB },
                new Object[] { "Basket Weaving 103", 2, LetterGradeEnum.B },
                new Object[] { "Basket Weaving 104", 2, LetterGradeEnum.BC },
                new Object[] { "Basket Weaving 105", 2, LetterGradeEnum.C },
                new Object[] { "Basket Weaving 106", 2, LetterGradeEnum.CD },
                new Object[] { "Basket Weaving 107", 2, LetterGradeEnum.F },
                new Object[] { "Ba", 1, LetterGradeEnum.F },
                new Object[] { "Ba", 0, LetterGradeEnum.F },
        };
    }
    ...
    public Object[][] equalsOperationDataProvider() {
        CompletedCourse c = new CompletedCourse("Bob", 1, LetterGradeEnum.A);

        return new Object[][] {
                new Object[] { new CompletedCourse("Bob", 1, LetterGradeEnum.A),
                        new CompletedCourse("Bob", 1, LetterGradeEnum.A), true },
                new Object[] { new CompletedCourse("Bob", 1, LetterGradeEnum.A),
                        new CompletedCourse("Bob", 2, LetterGradeEnum.A), false },
                new Object[] { new CompletedCourse("Bob", 1, LetterGradeEnum.A), new String("Hi"), false },
                new Object[] { new CompletedCourse("Bob", 1, LetterGradeEnum.A),
                        new CompletedCourse("Bb", 1, LetterGradeEnum.A), false },
                new Object[] { new CompletedCourse("Bob", 1, LetterGradeEnum.A),
                        new CompletedCourse("Bob", 1, LetterGradeEnum.B), false },
    ...
    @Test(groups = { "CompletedCourseTests" }, dataProvider = "equalsOperationDataProvider")
    /**
     * This test will verify that the hashcode generated is the same for equal
     * objects.
     */
