...
/**
 * This class holds the main program for the triangle analyzer. It serves to
 * setup the file input
 * and read the file, passing lines into the triangle analyzer as is
 * appropriate.
 * 
 * @author schilling
 */
public class MainProgram {
    public static void main(String[] args) {
        ...
        try (Scanner theFile = new Scanner(inputFile);
                PrintStream outputFileStream = new PrintStream(new File(outputFile));) {
            /**
            ...
            while (theFile.hasNextLine()) {
                ...
                /**
                 * If the line is non-blank, process it. Otherwise ignore it, placing a blank
            ...
            /**
             * If the source file can not be found, print out an error to the console and
             * exit.
             */
