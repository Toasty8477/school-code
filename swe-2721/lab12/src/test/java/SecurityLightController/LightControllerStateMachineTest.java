...
public class LightControllerStateMachineTest {
    ...
    public void beforeMethod() throws NoSuchFieldException, IllegalAccessException {
        ...
        obs = Mockito.mock(LightControllerStateMachineObserverInterface.class);
    ...
    public void testSubscribe()
            throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException {
        Field f = LightControllerStateMachine.class.getDeclaredField("observers");
        f.setAccessible(true);

        List<LightControllerStateMachineObserverInterface> observers = (List<LightControllerStateMachineObserverInterface>) f
                .get(sm);
