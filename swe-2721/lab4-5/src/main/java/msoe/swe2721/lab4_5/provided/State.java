...
/**
 * This code is slightly modified from this
 * @see <a href="https://gist.github.com/webdevwilson/5271984/revisions">...</a>
 */
public enum State {
    ...
    public static State valueOfAbbreviation(final String abbr) {
        ...
        return Objects.requireNonNullElse(state, UNKNOWN);
    }
