...
public interface StockQuoteGeneratorInterface {
	 ...
	 * @param symbol This is the stock symbol.
	 * @throws WebsiteConnectionError
	 *             An exception will be thrown if a current stock quote can not
	 *             be obtained.
	 */
	public abstract StockQuoteInterface getCurrentQuote(String symbol) throws WebsiteConnectionError;
