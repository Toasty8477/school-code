...
/**
 * This class will handle playing error sounds.
 */
public class AudioErrorPlayer implements StockTickerAudioInterface {
	/**
	 * This enumeration defines the position within the file.
	 */
	enum Position {
		LEFT, RIGHT, NORMAL
	};
	...
	private static class WavePlayer implements Runnable {
		...
		/**
		 * This is the name of the file that is to be played.
		 */
		private String filename;

		/**
		 * This is the current position within the playback file.
		 */
		private Position curPosition;

		/**
		 * This is the external buffer size.
		 */
		 ...
		 * @param p This is the current index into the file.
		 */
